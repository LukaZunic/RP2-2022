        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6 text-black mt-5">
                ...
                <div class="row">
                    ...
                    <div class="px-5 col">
                    <label for="loginSelect" class="mb-1">Ja sam:</label>
                ...
                <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                    ...
                    <form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"  style="width: 23rem;">
                        ...
                        <div class="form-outline mb-4" id="jmbagInput">
                            ...
                            <input type="email" id="jmbag" name="jmbag" class="form-control form-control-lg" />
                        </div>
                        ...
                        <div class="pt-1 mb-4">
                            <button class="btn btn-lg btn-block btn-primary" type="submit">Pošalji</button>
                        </div>
